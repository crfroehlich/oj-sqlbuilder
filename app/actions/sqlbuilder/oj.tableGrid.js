...
(function () {
    ...
    */
    ...
    grid.addProp(OJ.constants.gridProperties.hideHeaders, true);
    grid.addProp(OJ.constants.gridProperties.border, false);


    /**
     * Add the listeners
    */
    grid.listeners.add(OJ.constants.gridListeners.bodyscroll, function () {
    ...
    grid.listeners.add(OJ.constants.gridListeners.render, function (view) {
        this.dd = {};
    ...
    grid.listeners.add(OJ.constants.gridListeners.drop, function (node, data, dropRec, dropPosition) {
